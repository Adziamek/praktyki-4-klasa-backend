        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnRequests_CustomerOrders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "CustomerOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Warehouses",
                columns: new[] { "Id", "Active", "City", "Code", "Name" },
                values: new object[,]
                {
                    { 1, true, "Warszawa", "WH-01", "Magazyn Główny Warszawa" },
                    { 2, true, "Wrocław", "WH-02", "Magazyn Wrocław" }
                });

            migrationBuilder.InsertData(
                table: "Locations",
                columns: new[] { "Id", "Active", "Code", "Name", "WarehouseId" },
                values: new object[,]
                {
                    { 1, true, "A-001", "Regał A1", 1 },
                    { 2, true, "A-002", "Regał A2", 1 },
                    { 3, true, "B-001", "Regał B1", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "5901234123457", "Samsung Galaxy Buds" },
                    { 2, 1, 1, "5901234123458", "Samsung Smart TV 50\"" },
                    { 3, 2, 2, "5901234123459", "Bosch Robot kuchenny" },
                    { 4, 2, 2, "5901234123460", "Bosch Ekspres do kawy" },
                    { 5, 3, 3, "5901234123461", "Logitech Mysz MX Master" },
                    { 6, 3, 3, "5901234123462", "Logitech Klawiatura K380" },
                    { 7, 1, 2, "5901234123463", "Samsung Pralka EcoBubble" },
                    { 8, 2, 3, "5901234123464", "Bosch Wiertarka udarowa" },
                    { 9, 3, 1, "5901234123465", "Logitech Kamera internetowa C920" },
                    { 10, 1, 1, "5901234123466", "Samsung Monitor 27\"" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerOrders_CreatedAt",
